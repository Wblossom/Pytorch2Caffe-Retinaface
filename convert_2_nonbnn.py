...
if __name__ == '__main__':
    ...
    txt = ""
    with open("./caffe_models/official_ours_mergebn.prototxt") as f:
        for line in f:
            txt += line.replace("scale", "conv")#.replace("_bn", "")
    with open("./caffe_models/official_ours_mergebn.prototxt", "w") as f:
            f.write(txt)
